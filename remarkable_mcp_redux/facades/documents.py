    ...
    def list(
        ...
        *,
        ...
        if not self._cache.exists():
            return paginate_response([], "documents", limit, offset, parent)
        ...
        return paginate_response(documents, "documents", limit, offset, parent)

    def get_info(self, doc_id: str, *, include_page_ids: bool = True) -> dict:
...
def _document_summary(
    ...
    """Build the per-document dict returned by list."""
    summary = {
        "doc_id": doc_id,
        "name": name,
        "type": meta.type,
